municipalities: list[tuple[str, str]] = [
    ...
    ("BARCIS", "PN"),
    ("BARD", "AO"),
    ("BARDELLO CON MALGESSO E BREGANO", "VA"),
    ("BARDI", "PR"),
    ("BARDINETO", "SV"),
    ("BARDOLINO", "VR"),
    ("BARDONECCHIA", "TO"),
    ...
    ("CALCIO", "BG"),
    ("CALCO", "LC"),
    ("CALDARO SULLA STRADA DEL VINO/KALTERN AN DER WEINSTRASSE", "BZ"),
    ("CALDAROLA", "MC"),
    ...
    ("CORSICO", "MI"),
    ("CORSIONE", "AT"),
    ("CORTACCIA SULLA STRADA DEL VINO/KURTATSCH AN DER WEINSTRASSE", "BZ"),
    ("CORTALE", "CZ"),
    ("CORTANDONE", "AT"),
    ("CORTANZE", "AT"),
    ("CORTAZZONE", "AT"),
    ...
    ("CORTINA SULLA STRADA DEL VINO/KURTINIG AN DER WEINSTRASSE", "BZ"),
    ("CORTINO", "TE"),
    ("CORTONA", "AR"),
    ("CORVARA", "PE"),
    ...
    ("CURINO", "BI"),
    ("CURNO", "BG"),
    ("CURON VENOSTA/GRAUN IM VINSCHGAU", "BZ"),
    ("CURSI", "LE"),
    ("CURTAROLO", "PD"),
    ("CURTATONE", "MN"),
    ("CURTI", "CE"),
    ...
    ("FICULLE", "TR"),
    ("FIDENZA", "PR"),
    ("FIE' ALLO SCILIAR/VOLS AM SCHLERN", "BZ"),
    ("FIEROZZO", "TN"),
    ("FIESCO", "CR"),
    ("FIESOLE", "FI"),
    ("FIESSE", "BS"),
    ...
    ("MAGOMADAS", "OR"),
    ("MAGRE' SULLA STRADA DEL VINO/MARGREID AN DER WEINSTRASSE", "BZ"),
    ("MAGREGLIO", "CO"),
    ("MAIDA", "CZ"),
    ("MAIERA'", "CS"),
    ("MAIERATO", "VV"),
    ...
    ("MONTAGNA SULLA STRADA DEL VINO/MONTAN AN DER WEINSTRASSE", "BZ"),
    ("MONTAGNANA", "PD"),
    ("MONTAGNAREALE", "ME"),
    ("MONTAGUTO", "AV"),
    ("MONTAIONE", "FI"),
    ...
    ("MOSCUFO", "PE"),
    ("MOSO IN PASSIRIA/MOOS IN PASSEIER", "BZ"),
    ("MOSSA", "GO"),
    ("MOTTA BALUFFI", "CR"),
    ("MOTTA CAMASTRA", "ME"),
    ("MOTTA D'AFFERMO", "ME"),
    ...
    ("RAPONE", "PZ"),
    ("RASSA", "VC"),
    ("RASUN ANTERSELVA/RASEN-ANTHOLZ", "BZ"),
    ("RASURA", "SO"),
    ("RAVANUSA", "AG"),
    ("RAVARINO", "MO"),
    ("RAVASCLETTO", "UD"),
    ...
    ("SALMOUR", "CN"),
    ("SALO'", "BS"),
    ("SALORNO SULLA STRADA DEL VINO/SALURN AN DER WEINSTRASSE", "BZ"),
    ...
    ("SAN LEO", "RN"),
    ("SAN LEONARDO", "UD"),
    ("SAN LEONARDO IN PASSIRIA/ST. LEONHARD IN PASSEIER", "BZ"),
    ...
    ("SAN LORENZO DI SEBATO/ST. LORENZEN", "BZ"),
    ...
    ("SAN MARTINO IN BADIA/ST. MARTIN IN THURN", "BZ"),
    ("SAN MARTINO IN PASSIRIA/ST. MARTIN IN PASSEIER", "BZ"),
    ...
    ("SAN NICOLO' GERREI", "SU"),
    ("SAN PANCRAZIO SALENTINO", "BR"),
    ("SAN PANCRAZIO/ST. PANKRAZ", "BZ"),
    ("SAN PAOLO", "BS"),
    ...
    ("SANTA CRISTINA VALGARDENA/ST. CHRISTINA IN GRODEN", "BZ"),
    ...
    ("SELLIA", "CZ"),
    ("SELLIA MARINA", "CZ"),
    ("SELVA DEI MOLINI/MUHLWALD", "BZ"),
    ("SELVA DI CADORE", "BL"),
    ("SELVA DI PROGNO", "VR"),
    ("SELVA DI VAL GARDENA/WOLKENSTEIN IN GRODEN", "BZ"),
    ...
    ("SEMPRONIANO", "GR"),
    ("SENAGO", "MI"),
    ("SENALE-SAN FELICE/UNSERE LIEBE FRAU IM WALDE-ST. FELIX", "BZ"),
    ("SENALES/SCHNALS", "BZ"),
    ("SENEGHE", "OR"),
    ("SENERCHIA", "AV"),
    ("SENIGA", "BS"),
    ...
    ("TERLIZZI", "BA"),
    ("TERME VIGLIATORE", "ME"),
    ("TERMENO SULLA STRADA DEL VINO/TRAMIN AN DER WEINSTRASSE", "BZ"),
    ("TERMINI IMERESE", "PA"),
    ("TERMOLI", "CB"),
    ("TERNATE", "VA"),
    ("TERNENGO", "BI"),
    ...
    ("TRIVIGNO", "PZ"),
    ("TRIVOLZIO", "PV"),
    ("TRODENA NEL PARCO NATURALE/TRUDEN IM NATURPARK", "BZ"),
    ("TROFARELLO", "TO"),
    ("TROIA", "FG"),
    ("TROINA", "EN"),
    ("TROMELLO", "PV"),
    ...
    ("TROVO", "PV"),
    ("TRUCCAZZANO", "MI"),
    ("TUBRE/TAUFERS IM MUNSTERTAL", "BZ"),
    ("TUFARA", "CB"),
    ("TUFILLO", "CH"),
    ("TUFINO", "NA"),
    ("TUFO", "AV"),
